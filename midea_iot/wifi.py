...
class WifiCommand(enum.IntEnum):
    ...
    COMMAND_CONFIGURE_WIFI_REQUEST = 0x70
    COMMAND_CONFIGURE_WIFI_RESPONSE = 0x8070
    COMMAND_DEVICE_BATCH_DATA_TRANSMIT = 0xD0
    COMMAND_DEVICE_BATCH_DATA_TRANSMIT_RESPONSE = 0x80D0
    COMMAND_DEVICE_BATCH_REPORT_SUBDEVICES = 0xD1
    COMMAND_DEVICE_BATCH_REPORT_SUBDEVICES_RESPONSE = 0x80D1
    COMMAND_DEVICE_BROADCAST = 0x7A
    COMMAND_DEVICE_BROADCAST_RESPONSE = 0x807A
    COMMAND_DEVICE_DATA_TRANSMIT = 0x20
    COMMAND_DEVICE_DATA_TRANSMIT_RESPONSE = 0x8020
    COMMAND_DEVICE_NEW_ENERGY_DATA_PUSH = 0xD7
    COMMAND_DEVICE_NEW_ENERGY_DATA_PUSH_RESPONE = 0x80D7
    COMMAND_DEVICE_NEW_ENERGY_DATA_TRANSMIT = 0xD6
    COMMAND_DEVICE_NEW_ENERGY_DATA_TRANSMIT_RESPONSE = 0x80D6
    COMMAND_DEVICE_NEW_ENERGY_SUBORDER_OPERATION = 0x1
    COMMAND_DEVICE_NEW_ENERGY_SUBORDER_QUERY = 0x3
    COMMAND_DEVICE_NEW_ENERGY_SUBORDER_QUERYALL = 0x4
    COMMAND_DEVICE_NEW_ENERGY_SUBORDER_SET = 0x2
    COMMAND_DEVICE_OBJECT_MODEL_DATA_TRANSMIT = 0xD4
    COMMAND_DEVICE_OBJECT_MODEL_DATA_TRANSMIT_RESPONSE = 0x80D4
    COMMAND_DEVICE_OBJECT_MODEL_STATE_REPORT = 0xD5
    COMMAND_DEVICE_OBJECT_MODEL_STATE_REPORT_RESPONSE = 0x80D5
    COMMAND_DEVICE_QUERY_LAST_ERRORCODE = 0x73
    COMMAND_DEVICE_QUERY_LAST_ERRORCODE_RESPONSE = 0x8073
    COMMAND_DEVICE_SEND_WIFIINFO = 0x72
    COMMAND_DEVICE_SEND_WIFIINFO_RESPONSE = 0x8072
    COMMAND_DEVICE_STATE_REPORT = 0x40
    COMMAND_DEVICE_STATE_REPORT_NEED_RESPONSE = 0x44
    COMMAND_DEVICE_STATE_REPORT_RESPONSE = 0x8044
    COMMAND_QUERY_COMBINATION_REQUEST = 0x74
    COMMAND_QUERY_COMBINATION_RESPONSE = 0x8074
    COMMAND_QUERY_ERROR_REQUEST = 0x71
    COMMAND_QUERY_ERROR_RESPONSE = 0x8071
    COMMAND_SEARCH_DEVICE_BROADCAST = 0x92
    COMMAND_SEARCH_DEVICE_BROADCAST_RESPONSE = 0x8092
    COMMAND_SEND_HEART_BEAT = 0x7B
    COMMAND_SEND_HEART_BEAT_RESPONSE = 0x807B
    COMMAND_SWITCH_WIFI_MODE = 0x81
    COMMAND_SWITCH_WIFI_MODE_RESPONSE = 0x8081
    COMMAND_WRITE_DEVICE_ID = 0x43
    COMMAND_WRITE_DEVICE_ID_RESPONSE = 0x8043
    COMMAND_WRITE_WIFI_INFO = 0x68
    COMMAND_WRITE_WIFI_INFO_RESPONSE = 0x8068
